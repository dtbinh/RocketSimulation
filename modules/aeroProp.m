...
%%% THIS SECTION ON THE BODY AERODYNAMICS NEEDS MASSIVE FIXING. 1. NEED TO
%%% GO TO AEROBALLISTIC COORDS TO WORK OUT NORMAL FORCE. 2. FIND OUT HOW TO
%%% GET LIFT AND DRAG FROM ANGLE OF ATTACK AND PLANFORM AREA

% Angle of attack of the body
vwbB = Tbl * vwbL;
alfa = atan2(vwbB(3),vwbB(1));

% Lift and drag on the body
bodyLift = 0;
bodyDrag = 0;
